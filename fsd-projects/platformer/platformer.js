$(function () {
  ...
  function setup() {
    ...
    createPlatform(430, 400, 75, 10, "darkblue");
    ...
    createCollectable("steve", 430, 690,);
    ...
    createCannon("top", 875, 5000, 50, 20000, 200);
    createCannon("top", 975, 5000, 50, 20000, 200);
    createCannon("top", 1075, 5000, 50, 20000, 200);
    createCannon("top", 1175, 5000, 50, 20000, 200);
    createCannon("top", 1275, 5000, 50, 20000, 200);
    createCannon("top", 300, 60000, 800, 20000, 200);
    createCannon("right", 200, 10, 20, 20, 200);
    createCannon("right", 500 , 2000 ,100 ,20, 1);
